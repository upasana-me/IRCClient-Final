...
public class DccChatTab extends JPanel
{
    ...
    private DccConnection connection;
    ...
    public DccChatTab(String senderNickName, TabGroup tabGroup, DccConnection dccConnection)
    {
	...
	*/
    ...
    {
	textPane.setSockClosed(nick, message);
    }
}